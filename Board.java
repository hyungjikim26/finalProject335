...
public class Board {
	...
	/**
	 * Add a random tile to the board. If board is full, tile is not added
	 * 
	...
	/**
	 * All nonempty tiles are moved up and merged if two identical tiles are
	 * vertically adjacent or have only empty tiles between them.
	 * 
	...
	/**
	 * All nonempty tiles are moved right and merged if two identical tiles are
	 * horizontally adjacent or have only empty tiles between them.
	 * 
	 * @return true if board was changed during move, false if not
	 */
	...
	/**
	 * All nonempty tiles are moved down and merged if two identical tiles are
	 * vertically adjacent or have only empty tiles between them.
	 * 
	 * @return true if board was changed during move, false if not
	 */
	...
	/**
	 * All nonempty tiles are moved left and merged if two identical tiles are
	 * horizontally adjacent or have only empty tiles between them.
	 * 
	 * @return true if board was changed during move, false if not
	 */
	...
	/**
	 * Checks the loosing conditon of the game
	 * 
	 * @pre none
	 * @post none
	 * @param none
